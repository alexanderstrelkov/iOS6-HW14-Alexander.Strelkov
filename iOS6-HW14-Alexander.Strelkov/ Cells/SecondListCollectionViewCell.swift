//
//  SecondListCollectionViewCell.swift
...
class SecondListCollectionViewCell: UICollectionViewCell {

    static let identifier = "SecondListCollectionViewCell"
...
extension SecondListCollectionViewCell {
    func configure() {
